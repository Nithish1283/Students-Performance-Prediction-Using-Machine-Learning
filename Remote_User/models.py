...
class student_performance_model(models.Model):
    ...
    Diagnostic_Assessments_Grade= models.IntegerField()
    Formative_Assessments_Grade= models.IntegerField()
    Interim_Assessments_Grade= models.IntegerField()
    Summative_Assessments_Grade= models.IntegerField()
